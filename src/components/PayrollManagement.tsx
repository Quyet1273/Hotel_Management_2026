  ...
  if (authLoading) {
    return (
      ...
      >
        ...
        <p style={{ marginTop: "16px", color: "#64748b", fontWeight: "bold" }}>
    ...
    return (
      ...
      >
        ...
        <p style={{ color: "#64748b" }}>
          Vui lòng đăng nhập vào hệ thống để sử dụng tính năng Chấm công &
          Lương.
        </p>
      </div>
    );
      ...
      >
        ...
        >
          ...
          <div>
            ...
            >
              Hệ thống quản lý tự động HotelPro
            </p>
          </div>
        </div>
      </div>
      ...
      >
        <button
          ...
          style={{
            ...
            gap: "8px",
            backgroundColor:
              activeTab === "attendance" ? "#ffffff" : "transparent",
        ...
        {isManager && (
          <button
            ...
            style={{
              ...
              gap: "8px",
              backgroundColor:
                activeTab === "payroll" ? "#ffffff" : "transparent",
                      ...
                      <div style={{ textAlign: "right" }}>
                        ...
                        >
                          ...
                          <span
                            style={{
                              color:
                                log.late_minutes > 0 ? "#f59e0b" : "#10b981",
                            }}
                          >
                            {log.check_in
                        ...
                        >
                          ...
                          <span
                            style={{
                              color:
                                log.early_minutes > 0 ? "#f43f5e" : "#10b981",
                            }}
                          >
                            {log.check_out
