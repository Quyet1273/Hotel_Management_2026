  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500 pb-10">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 text-sm italic">
            Quản lý nhận phòng, trả phòng & thanh toán tức thì
          </p>
        </div>
      ...
      <div className="bg-white rounded-[2rem] border border-gray-100 shadow-sm overflow-hidden">
          ...
          {Object.keys(tabConfig).map((key) => {
            ...
            return (
              ...
              >
                <span
                  style={{
                    color: isActive || isHovered ? config.base : "#94a3b8",
                  }}
                >
        ...
        {/* Housekeeping Management - chỉ hiển thị ở Tab "pending" */}
        {activeTab === "pending" && (
          <div
            style={{
              backgroundColor: "#f8fafc",
        ...
        <div className="divide-y divide-gray-50">
          {filteredBookings.length > 0 ? (
            filteredBookings.map((booking) => (
              <div
                key={booking.id}
                className="p-6 hover:bg-slate-50/50 transition-all cursor-default group"
              >
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                  <div className="grid grid-cols-3 flex-1 gap-6 items-center">
                    ...
                    <div
                      ...
                      style={{ gap: "8px", minWidth: "140px", flexShrink: 1 }}
                    >
                      <div
                        style={{
                          width: "36px",
            ...
            <div className="p-20 text-center">
              ...
              <p className="text-gray-400 font-medium">
                Hiện không có yêu cầu nào trong danh sách này
              </p>
            </div>
          )}
        </div>
